...
void windows_set(struct windows_content*std,struct layer_content *ads,int xsize,int ysize,int x,int y,int color,struct layer_backs *backs){
	std->content_ads = ads;
