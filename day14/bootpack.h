...
void draw_mouse(int setx,int sety,int a,int b,int c,char * fontpk,unsigned char *ads);//绘制鼠标形状setx，y起始坐标，啊a,b,c颜色，fontpk字体库
void draw_rout(int x, int y,char*ads);//自定义图形
...
char *content_ads;
int xsize,ysize,x,y,height,flage;
